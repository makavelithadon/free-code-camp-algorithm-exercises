// Based on https://www.freecodecamp.org/challenges/inventory-update FreeCodeCamp exercise
...
function updateInventory(...arrays) {
  // All inventory must be accounted for or you're fired!
  return Object.entries(arrays
    .reduce((acc, array) => [...acc, ...array], [])
    .sort((a, b) => a[1].localeCompare(b[1]))
    .reduce((acc, array) => ({function updateInventory(...arrays) {
  // All inventory must be accounted for or you're fired!
  return Object.entries(arrays
    .reduce((acc, array) => [...acc, ...array], [])
    .sort((a, b) => a[1].localeCompare(b[1]))
    .reduce((acc, array) => ({
      ...acc, [array[1]]: array[1] in acc
        ? acc[array[1]] + array[0]
        : array[0]
    }), {}))
    .map(arr => arr.reverse());
